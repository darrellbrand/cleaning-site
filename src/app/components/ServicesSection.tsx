  ...
  return (
    <section className="bg-blue-400  px-6 marker-font -mt-1" id="services">
      <div className="max-w-7xl mx-auto text-center ">
        <h2 className="text-5xl font-bold text-blue-100 mb-12">
        ...
        <div className="grid gap-10 md:grid-cols-2 text-left">
          ...
          <div className="bg-blue-200 p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl md:text-4xl font-semibold text-blue-600">Basic House Cleaning</h3>
            </div>
            <ul className="list-disc list-inside text-blue-500 space-y-2 mb-4 text-xl md:text-2xl">
          ...
          <div className="bg-blue-200 p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl md:text-4xl font-semibold text-blue-600">Commercial Cleaning</h3>
            </div>
            <ul className="list-disc list-inside text-blue-500 space-y-2 mb-4 text-xl md:text-2xl">
