                ...
                <div className='flex flex-col items-center justify-center gap-5  w-full text-center'>
                    ...
                    <div className='flex flex-row items-center justify-center gap-4 w-full '>
                        <button>
                            <Link
                                href="#contact"
                                className="inline-block bg-blue-100 text-blue-600 font-semibold py-3 px-4 md:py-6 md:px-9 rounded-full hover:bg-blue-300 transition duration-300 text-xl md:text-2xl marker-font "
                            >
                                Get a Free Quote
                            </Link>
                        </button>
                        <div className='relative w-[150px] md:w-[500px] aspect-[4/3] flex-shrink-0'>
                            <Image
                                src="/spray.png"
                                alt="Background"
                                fill
